...
public class Main {
		...
		for(Produto produto : produtoarray) {
			if(produto instanceof Medicamento) {
				...
				Cosmetico cosmetico = (Cosmetico) produto;
					...
					System.out.println("ID: " + cosmetico.getid());
				...
				Vitamina vitamina = (Vitamina) produto;
					...
					System.out.println("ID: " + vitamina.getid());
	...
	public static void main(String[] args) {
		...
		Medicamento novoproduto = new Medicamento("Dipirona", (float) 5.55, "23/04/2024",
				"Prati Dondaduzzi Genérico", 25, 1, "500mg", "DIPIRONA SODICA");

		farmacia.addproduto(novoproduto);

		Cosmetico novoproduto2 = new Cosmetico("Creme Anti-Imperfeições", (float) 142.99, "26/05/2023",
				"La Roche-Posay", 50, 2, "40ml", "Uso externo. Não ingerir. Caso haja contato com olhos, lave-os. Se houver irritação, suspenda o uso imediatamente e procure orientação médica.");
		
		farmacia.addproduto(novoproduto2);
		
		Vitamina novoproduto3 = new Vitamina("Suplemento Vitamínico Adeforte", (float) 20.33, "05/11/2023",
				"Gross", 15, 3, "1 ampola", "VITAMINA A, VITAMINA D");
